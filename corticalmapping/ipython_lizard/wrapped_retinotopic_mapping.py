...
class WrappedRetinotopicMapping(RetinotopicMapping.RetinotopicMappingTrial):
    ...
    def getSignMap(self,phaseMapFilterSigma,signMapFilterSigma,isReverse=False,
        ...
        self._getSignMap(isReverse=isReverse,isPlot=True,
                         isFixedRange=isFixedRange)
    
    def getRawPatchMap(self,signMapThr,openIter,closeIter):
        ...
        self._getRawPatchMap(isPlot=True)
    
    def getRawPatches(self,dilationIter,borderWidth,smallPatchThr):
        ...
        self._getRawPatches(isPlot=True)
    
    def getDeterminantMap(self):
        self._getDeterminantMap(isPlot=True)
    ...
    def getEccentricityMap(self,eccMapFilterSigma):
        ...
        self._getEccentricityMap(isPlot=True)
...
#         return eccMap, eccMapf
    def splitPatches(self,visualSpacePixelSize,visualSpaceCloseIter,
                     splitLocalMinCutStep,splitOverlapThr):
        ...
        self._splitPatches(isPlot=True)
#    def splitPatches(self,visualSpacePixelSize,visualSpaceCloseIter,
...
#        self._splitPatches(isPlot=isPlot)
    ...
    def mergePatches(self,mergeOverlapThr):
        ...
        self._mergePatches(isPlot=True)    
