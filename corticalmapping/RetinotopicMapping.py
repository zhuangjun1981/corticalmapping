...
class RetinotopicMappingTrial(object):
    ...
    def _getSignMap(self, isReverse = False, isPlot = False, isFixedRange = True):
        ...
        if isPlot:
            ...
            if isFixedRange: currfig = f1_231.imshow(self.altPosMap, vmin=-50, vmax=70, cmap='hsv', interpolation='nearest')
            ...
            if isFixedRange: currfig = f1_232.imshow(self.aziPosMap, vmin=-10, vmax=130, cmap='hsv', interpolation='nearest')
