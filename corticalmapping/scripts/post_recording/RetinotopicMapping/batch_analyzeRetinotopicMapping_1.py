...
dateRecorded = '171215' # str 'yymmdd'
mouseID = '321607' # str, without 'M', for example: '214522'
userID = 'mattv' # user name, should be consistent withe the display log user name
mouseType='Slc17a7;Ai162(TITL-GCaMP6s)'
trialNum='4' # str
vasfileNums = [102] # file numbers of vasculature images, should be a list
fileNum = 102 # file number of the imaged movie
