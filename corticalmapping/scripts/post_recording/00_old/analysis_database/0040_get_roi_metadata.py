...
params['is_collapse_sf'] = False
params['is_collapse_tf'] = False
...
def process_one_nwb_for_multi_thread(inputs):
    ...
    if os.path.isfile(save_path):
        print('\tt: {:5.0f} minutes, {} , excel table already exists, skip.'.format((time.time() - t0) / 60., nwb_fn))
        return None
    else:
        ...
        for plane_n in plane_ns:
            print('\tt: {:5.0f} minutes, {} / {}, processing ...'.format((time.time() - t0) / 60., nwb_fn, plane_n))
