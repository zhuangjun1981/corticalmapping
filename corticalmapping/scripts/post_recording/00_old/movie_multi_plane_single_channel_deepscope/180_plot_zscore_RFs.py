...
for plane_n in plane_ns:
    ...
    for roi_ind, roi_n in enumerate(roi_ns):
        ...
        rf_on.plot_rf(plot_axis=ax_on, is_colorbar=True, cmap='Reds', vmin=zscore_range[0], vmax=zscore_range[1])
        ax_off = f.add_subplot(122)
        rf_off.plot_rf(plot_axis=ax_off, is_colorbar=True, cmap='Blues', vmin=zscore_range[0], vmax=zscore_range[1])
        plt.close()
