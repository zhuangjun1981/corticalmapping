...
class RetinotopicMappingTrial(object):
    ...
    def getName(self):
        ...
        trialName = str(self.dateRecorded)+'_M'+self.mouseID+'_Trial' + self.trialNum + '_' + self.visualStimType + '_' + self.visualStimBackground
    ...
    def _getSignMap(self, isPlot = False):
